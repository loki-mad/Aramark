...
import { getShiftsByRestaurant } from "../State/Shift/Action";
...
const Admin = () => {
  ...
  useEffect(() => {
    if (restaurant.usersRestaurant) {
      ...
      // Fetch workers and shifts for the restaurant
      dispatch(getWorkersByRestaurant(restaurant.usersRestaurant?.id));
      dispatch(getShiftsByRestaurant(restaurant.usersRestaurant?.id));
    }
